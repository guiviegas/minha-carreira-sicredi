...
export const pcDashboardData = {
  careerHealth: {
    systemAverage: 62,
    branchRanking: [
      { branch: 'Agência Centro', score: 82 },
      { branch: 'Agência Vale', score: 77 },
      { branch: 'Agência Leste', score: 75 },
      { branch: 'Agência Serra', score: 73 },
      { branch: 'Agência Sul', score: 71 },
      { branch: 'Agência Oeste', score: 69 },
      { branch: 'Agência Campanha', score: 52 },
      { branch: 'Agência Norte', score: 48 },
    ],
    readyForNextStep: 14,
    overdueDevPlans: 23,
  },
