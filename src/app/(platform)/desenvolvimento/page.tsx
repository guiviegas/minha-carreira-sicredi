...
const courses = [
  { id: 'c1', title: 'Cultura Cooperativista na Prática', desc: 'Como viver os valores cooperativos no dia a dia e fortalecer vínculos com associados', type: 'video' as const, duration: '4h', provider: 'Sicredi Aprende', skills: ['#GENTE QUE FAZ JUNTO'], progress: 30, rating: 4.8, category: 'cooperativismo', icon: Building2 },
  { id: 'c2', title: 'Escuta Ativa para Atendimento', desc: 'Técnicas de escuta empática e mediação de conflitos com associados', type: 'interactive' as const, duration: '2h', provider: 'Sicredi Aprende', skills: ['#GENTE QUE ENTENDE DE GENTE'], progress: 0, rating: 4.6, category: 'soft', icon: Handshake },
  { id: 'c3', title: 'Análise Financeira para GNs', desc: 'Leitura de balanços, DRE e indicadores, base para decisões de crédito', type: 'video' as const, duration: '6h', provider: 'Sicredi Aprende', skills: ['#GENTE QUE GERA PROSPERIDADE'], progress: 0, rating: 4.5, category: 'financeira', icon: BarChart3 },
  { id: 'c4', title: 'Liderança e Feedback Papo Reto', desc: 'Metodologia de feedback estruturado e conversas de PDI com pessoas da equipe', type: 'mentoring' as const, duration: '8h', provider: 'Programa S2S', skills: ['#GENTE QUE ENTENDE DE GENTE', '#GENTE QUE GERA CONFIANÇA'], progress: 0, rating: 4.9, category: 'lideranca', icon: Target },
  { id: 'c5', title: 'Governança Cooperativa', desc: 'Assembleia, conselho, comitês e o papel do associado na governança', type: 'article' as const, duration: '1.5h', provider: 'Sicredi Aprende', skills: ['#GENTE QUE FAZ O CERTO'], progress: 100, rating: 4.3, category: 'cooperativismo', icon: Building2 },
  { id: 'c6', title: 'OKRs e Planejamento Estratégico', desc: 'Como definir e cascatear objetivos alinhados à estratégia da cooperativa', type: 'interactive' as const, duration: '3h', provider: 'Sicredi Aprende', skills: ['#GENTE QUE GERA PROSPERIDADE'], progress: 0, rating: 4.7, category: 'estrategica', icon: Lightbulb },
  { id: 'c7', title: 'Gestão de Carteira Premium', desc: 'Estratégias de cross-selling e retenção para associados alta renda', type: 'video' as const, duration: '3h', provider: 'Sicredi Aprende', skills: ['#GENTE COM QUEM CONTAR'], progress: 100, rating: 4.4, category: 'comercial', icon: Coins },
  { id: 'c8', title: 'Mindset de Evolução Contínua', desc: 'Adaptabilidade, agilidade de aprendizado e abertura ao novo no contexto digital', type: 'practice' as const, duration: '2h', provider: 'Programa Bem-Estar', skills: ['#GENTE QUE EVOLUI'], progress: 65, rating: 4.8, category: 'soft', icon: Brain },
  { id: 'c9', title: 'Design Thinking para Cooperativas', desc: 'Ferramentas de inovação aplicadas ao contexto cooperativo', type: 'video' as const, duration: '2h', provider: 'Sicredi Aprende', skills: ['#GENTE QUE EVOLUI'], progress: 0, rating: 4.5, category: 'estrategica', icon: TrendingUp },
];
